...
### read csv
def readcsv():
    filepath = 'C:\\import\\text_anal\\New feature\\%s.csv' % qt
    f = open(filepath, 'r')
...
def tokenize(matrix) :
    ...
    for s in matrix:
        ...
        a = nltk.tokenize.word_tokenize(s[5].lower())
...
#        wc.append(wordcount.items())
    ...
    mtokenm = zip(docidn,vtypen,vdetailn,fsf)
    return mtokenm
...
filepath_exp = 'C:\\import\\text_anal\\New feature\\%s_stop.csv' % qt
