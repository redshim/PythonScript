			...
			for (HashMap<String, Object> keyword : keywordList) {
				...
				try {	
					...
					if (!isDate) {
						...
						List<HashMap<String, Object>> naverCafe =urlParserService.getUrlParsing(param2);
						List<HashMap<String, Object>> daumBlog = urlParserService.getUrlParsing(param3);
						List<HashMap<String, Object>> daumCafe =urlParserService.getUrlParsing(param4);
						
						try {
							TextSave ts = new TextSave();
							ts.textSave(naverBlog, param1);
							ts.textSave(naverCafe, param2);
							ts.textSave(daumBlog, param3);
							ts.textSave(daumCafe, param4);
